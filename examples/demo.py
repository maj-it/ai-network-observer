...
def example_2_privacy_masking():
    ...
    sensitive_data = {
        ...
        "http_requests": [
            {
                "method": "POST",
                "url": "https://api.example.com/users/profile?api_key=API_KEY_REDACTED_long_secret_key_abc123",
                "body": "email=john.doe@example.com&password=EXAMPLE_PASSWORD&phone=555-0100"
            }
        ]
    }
