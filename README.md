...
L'AI Network Observer intègre un module avancé de détection de keyloggers analysant le trafic réseau pour identifier:

- **Exfiltration de données clavier** (encodage Base64, patterns suspects)
- **Communications C2** (Discord webhooks, bots Telegram, Pastebin)
- **Trafic périodique** automatisé (signature d'exfiltration régulière)

**Documentation complète** : [docs/KEYLOGGER_DETECTION.md](docs/KEYLOGGER_DETECTION.md)

**Formation référencée** : [Keylogger Python POC](https://lnkd.in/d9YeuEy8)
...
if result['is_suspicious']:
    print(f"⚠️ Keylogger détecté ! Risk: {result['risk_score']}/10")
\`\`\`
