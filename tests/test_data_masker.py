...
class TestDataMasker:
    ...
    def test_pii_detection_api_key(self, masker):
        ...
        text = 'api_key="API_KEY_REDACTED"'
        masked = masker._mask_string(text)
        
        # API key should be masked
        assert "API_KEY_REDACTED" not in masked
...
class TestPIIDetector:
    ...
    def test_api_key_detection(self, detector):
        """Test API key detection"""
        data = {
            'config': 'api_key=API_KEY_REDACTED'
        }
            ...
            'network_flows': [
                {
                    ...
                    'payload': 'username=john.doe@example.com&password=REDACTED&phone=555-1234'
                }
            ]
        }
